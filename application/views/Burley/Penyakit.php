		...
		<div class="container" style="margin-top: 2.5%;">
			...
			<a href="<?php echo site_url('agribisnis') ?>" style="text-decoration-line:none;" title="Klik untuk menuju halaman Agribisnis"><h3 class="text-center" style="color:black;font-family: helmet; "><strong>Penyakit / Hama</strong></h3></a>
			<hr style="border-color: grey">
			<center><img src="<?php echo base_url('assets/penyakit/').$penyakit->file_gambar ?>" class="image img-rounded" style="box-shadow: 5px 5px 5px 0px rgba(0,0,0,0.2); width:35%">				
			</center>
			<p style="text-align: justify; text-indent: 0.5in;"><center><span style="font-size: 20px; font-weight: unset; font-family: hobo std; color: rgb(242,97,5);"><?= $penyakit->judul ?></span></center><br><?= $penyakit->deskripsi ?>
			</p>
			<br>
				...
				?>
										...
										<button class="accordion actived" style="border-bottom: 2px solid white;"><strong class="pencarian"><?= $p->judul ?></strong></button>
												...
												<div class="container-fluid panel"> -->
													<br>
													<center><img src="<?php echo base_url('assets/penyakit/').$p->file_gambar ?>" width="450px" alt=""></center>
													<p style="text-indent: 0.5in;text-align:justify;" class="pencarian"><?= $p->deskripsi ?></p>													
													<br>
													<p style="color: #5cb85c;"><b>Catatan:</b></p>
													<p>Pembahasan lebih lanjut monograf <b class="pencarian">Penyakit Tanaman Tembakau Virginia</b> dapat diunduh <a href="<?= base_url('assets/SK/').$p->file_SK ?>" target="blank" class="hoverThumbnail" style="text-decoration-line: none"><b>di sini</b></a>.</p>
													<br>
												</div>
