...
<body>
	...
	<div class="container">
		<ul class="breadcrumb" style="margin-bottom: 0px;margin-top: 10%;">
			...
			<li><a style="color: black;" href="<?php echo base_url('agribisnis') ?>">Budidaya Tembakau</a></li>
			<li class="active">Detil Budidaya</li>
		</ul>
		<div class="row">
			<div class="col-sm-9 col-lg-9">
				...
				<?php
				foreach ($budidaya as $rowA) {
					$temParagraf = explode('</p>', $rowA->deskripsi);
				?>
					<div class="row" style="margin-bottom: 20px;">
						<div class="col-xs-12 col-sm-12 col-lg-12">
							<div class="thumbnail" style=" border-radius: 5px; background-color: white; border-color: white;">
								<img src="<?php echo base_url() ?>assets/budidaya/<?php echo $rowA->file_gambar; ?>" alt="" style="width: 100%;border-radius: 3px;">
								<br>
								<div class="container-fluid">
									<h4 style="color:rgb(242,97,5); font-size: 24px; font-family: helmet;"><strong class="pencarian"><?php echo $rowA->nama_budidaya; ?></strong></h4>
									<?php
									...
									<p>Pembahasan lebih lanjut monograf <b class="pencarian"><?php echo $rowA->nama_budidaya; ?></b> dapat diunduh <a href="<?php echo base_url() ?>assets/SK/<?php echo $rowA->file_SK; ?>" target="blank" class="hoverThumbnail" style="text-decoration-line: none"><b>di sini</b></a>.</p>
									<br>
								</div>
								<br>
								<br>
								<div style="text-align: right; margin-bottom: 10px;margin-right: 10px;">
									...
									<a id="button" onclick="window.open('http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?php echo $rowA->nama_budidaya; ?>&amp;p[summary]=<?php echo substr($rowA->deskripsi, 0, 25); ?>&amp;p[url]=<?php echo base_url(); ?>&amp;&p[images][0]=<?php echo base_url(); ?>assets/budidaya/<?php echo $rowA->file_gambar; ?>', 'sharer', 'toolbar=0,status=0,width=550,height=400');" target="_parent" href="javascript: void(0)">
										<span><img src="<?php echo base_url() ?>assets/icon/fb.png" /></span>
									</a>
									<!-- SHARE LINK UNTUK TWITTER -->
									<a class="twitter popup" href="http://twitter.com/share?source=sharethiscom&text=<?php echo "Agribisnis Tembakau : " . $rowA->nama_budidaya; ?>&url=<?php echo base_url(); ?>&via=berbagiyuks" target="blank">
										<span><img src="<?php echo base_url() ?>assets/icon/twitter.png" /></span>
									</a>
									<!-- SHARE LINK UNTUK GOOGLE PLUS -->
									<a href="javascript:void(0);" onclick="popUp=window.open('https://plus.google.com/share?url=<?php echo base_url('varietas/detailBudidaya/') . urlencode(strtolower($rowA->nama_budidaya)); ?> ','popupwindow','scrollbars=yes,width=800,height=400');popUp.focus();return false">
