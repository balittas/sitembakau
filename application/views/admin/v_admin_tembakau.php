                        ...
                        <tbody>
                         ...
                         ?>
                            <tr>                  
                                ...
                                <td>
                                    <a href="#editbenih" class="edit" onclick="modal_edit_benih('<?php echo $ben->id_penyakit; ?>','<?php echo $ben->judul; ?>','<?php echo $ben->jenis_tembakau; ?>','<?php echo $ben->kota; ?>','<?php echo $ben->deskripsi; ?>');">
                                        <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                    </a>
